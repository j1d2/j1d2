...
def generate_svg(stats):
    ...
    svg = f'''<svg xmlns="http://www.w3.org/2000/svg" width="495" height="170" viewBox="0 0 495 170">
  <defs>
    <style>
  ...
  <rect x="0.5" y="0.5" width="494" height="169" rx="4.5" fill="{COLORS['bg']}" stroke="{COLORS['stroke']}" stroke-opacity="0"/>
  ...
  <text class="text" x="490" y="165" text-anchor="end" opacity="0.5" style="font-size: 10px">Updated: {datetime.utcnow().strftime('%Y-%m-%d')}</text>
</svg>'''
